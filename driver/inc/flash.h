 ...
 ******************************************************************************/
///<Flash 初始化配�?中断函数、编程时间参数及休眠模式配置�?en_result_t Flash_Init(func_ptr_t pfnFlashCb, uint8_t u8FreqCfg, boolean_t bDpstbEn);
...
///<Flash 读等待周期设�?en_result_t Flash_WaitCycle(en_flash_waitcycle_t enWaitCycle);
